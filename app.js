...
const ACTIONS = {
  soft: [
    ...
    "тронуть пальцем", "поцеловать", "слегка тронуть"
  ],
  spicy: [
    "страстно поцеловать", "несмело покусать", "провести кончиками пальцев",
    "медленно погладить", "страстно помассировать", "тронуть ладошкой"
  ],
  extra: [
    "ласково прикусить", "очертить линию губами",
    "провести языком", "страстно помассировать", "потрогать рукой"
  ]
};

const PARTS = {
  soft: ["шею", "ушко", "спину","талию", "руку", "голову"],
  spicy: ["бедро", "нижнюю губу", "внутреннюю сторону предплечья","поясницу","попу","коленку"],
